...
namespace Chat.FrontWeb.Controllers
{
    public class MemberLevelController : FrontBaseController
    {
        ...
        public ActionResult MemberLevel()
        {
            ...
            Model.UserPro = MemberLevelService.GetUserPro(getLoginID).UserPro;
            Model.MemberListDTO = Member.ToUser(getLoginID).MemberList.First();
        ...
        public ActionResult AgentLevel(string name = "system") //还差钱没扣
        {
            ...
            model.Member = Member.ToUser(getLoginID).MemberList.First();//查询这个人的信息 ，只要UserCode
        ...
        public ActionResult Agent_btn(int id) //提交
        {
            ...
            model.Agent = AgentServeice.GetAgentName(UserCode).AgentList;
        ...
        /// <summary>
        /// 查询状态--表内无数据，则显示Member表的UserCode
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
