...
namespace Chat.FrontWeb.Areas.Admin.Controllers
{
    public class MemberController : AdminBaseController
    {
        ...
        public ActionResult Member(int pageIndex = 1)
        {
            ...
            pager.TotalCount = MemberService.GetMemberList("0", "", "0", null, null, pageIndex, pageSize, 0).TotalCount;
            ...
            model.MemberList = MemberService.GetMemberList("0", "", "0", null, null, 1, 2, 0).MemberList;
            return View(model);
        }
        ...
        public ActionResult MemberList(int pageIndex = 1)
        {
            ...
            pager.PageIndex = pageIndex;
            pager.PageSize = pageSize;
            pager.TotalCount = MemberService.GetMemberList("0", "", "0", null, null, pageIndex, pageSize, 2).TotalCount;
